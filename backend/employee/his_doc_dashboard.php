                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title fs-3 fw-medium mt-2">Employee Dashboard</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box border border-info">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-info border-info border">
                                                <i class="mdi mdi-flask font-22 avatar-title text-info"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
                            ...
                            <div class="col-md-6 col-xl-4">
                                <div class="widget-rounded-circle card-box border border-info">
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="avatar-lg rounded-circle bg-soft-info border-info border">
                                            <i class=" fas fa-funnel-dollar font-22 avatar-title text-info"></i>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="text-right">
                                                ...
                                                <p class="text-muted mb-1 text-truncate">Inventory</p>
                                            </div>
                                        </div>
                                    </div> <!-- end row-->
                                </div> <!-- end widget-rounded-circle-->
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card-box">
                                    <h3 class="header-title fw-medium fs-4 mb-3">Patients Details</h3>
                                        ...
                                        <table class="table table-borderless table-hover table-centered m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="his_doc_view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>&&pat_name=<?php echo $row->pat_fname;?>_<?php echo $row->pat_lname;?>" class="btn btn-xs btn-info"><i class="mdi mdi-eye"></i> View</a>
                                                    </td>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   
                                                </tr>
                                            </tbody>
                                            <?php }?>
