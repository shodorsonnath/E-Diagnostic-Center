                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        <h4 class="page-title fs-3 fw-medium mt-3"><?php echo $row->doc_fname;?> <?php echo $row->doc_lname;?>'s Profile</h4>
                                    </div>
                                </div>
                            </div>
                            <!-- end page title -->
                                ...
                                <div class="col-lg-8 col-xl-8">
                                    <div class="card-box">
                                        <ul class="nav nav-pills navtab-bg nav-justified">
                                            <li class="nav-item">
                                                <a href="#aboutme" data-toggle="tab" aria-expanded="false" class="btn btn-success active">
                                                    Update Profile
                                                </a>
                                            </li>
                                            
                                            <li class="nav-item">
                                                <a href="#settings" data-toggle="tab" aria-expanded="false" class="btn btn-success">
                                                    Change Password
                                                </a>
                                            </li>
                                        </ul>
