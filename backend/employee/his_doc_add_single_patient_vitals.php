                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        ...
                                        <h4 class="page-title fs-3 fw-medium mt-2"><?php echo $row->pat_fname;?> <?php echo $row->pat_lname;?> Health Information</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <button type="submit" name="add_patient_vitals" class="ladda-button btn btn-success" data-style="expand-right">Add Details</button>
