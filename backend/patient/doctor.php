                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title fs-3 fw-medium mt-2">Appointment Doctor</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-4 custom-select-container">
                                                <label for="inputState" class="col-form-label">Select Hospital
                                                    Center</label>
                                            ...
                                            <div class="form-group col-md-4 custom-select-container">
                                                ...
                                                <input type="text" required="required" name="app_date"
                                                    class="form-control" id="inputEmail4" placeholder="DD/MM/YYYY">
                                            </div>
