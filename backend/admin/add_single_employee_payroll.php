                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <h4 class="page-title fs-3 fw-medium mt-2">Employee Salaray Details</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <form method="post">
                                                ...
                                                <button type="submit" name="add_payroll" class="ladda-button btn btn-success" data-style="expand-right">Payment</button>
