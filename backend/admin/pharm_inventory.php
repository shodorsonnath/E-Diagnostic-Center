                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h4 class="page-title fs-3 fw-medium mt-2">Pharmaceuticals Inventory</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                            ...
                                            */
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <!-- <td><a href="pharm_inventory.php?phar_bcode=<?php echo $row->phar_bcode;?>" class="badge badge-danger"><i class=" mdi mdi-trash-can-outline "></i> Delete</a></td> -->
                                                </tr>
                                                </tbody>
                                            <?php  $cnt = $cnt +1 ; }?>
                                            <tfoot>
