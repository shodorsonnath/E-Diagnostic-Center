                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <h4 class="page-title fs-3 fw-medium mt-2">Patient Record Details</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    ...
                                                    <hr>
                                                    <h3>Age : <?php echo $row->mdr_pat_age;?> Years</h3>
                                                    <hr>
                                                    <h3 >Patient Number : <?php echo $row->mdr_pat_number;?></h3>
                                                    <hr>
                                                    <h3 >Patient Ailment : <?php echo $row->mdr_pat_ailment;?></h3>
                                                    <hr>
                                                    <h3 >Date Recorded : <?php echo date("d/m/Y - h:m:s", strtotime($mysqlDateTime));?></h3>
                                                    <hr>
                                                    <h2 >Prescription</h2>
                                                    <hr>
                                                    <p>
