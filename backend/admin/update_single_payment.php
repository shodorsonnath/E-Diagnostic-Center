                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title fs-3 fw-medium mt-2">Payable Account Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form method="post">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    <label for="inputEmail4" class="col-form-label">Amount(TK)</label>
                                            ...
                                            <button type="submit" name="update_acc" class="ladda-button btn btn-success" data-style="expand-right">Update Account</button>
