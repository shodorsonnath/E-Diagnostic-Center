<?php
	...
	include('assets/inc/config.php');
		if(isset($_POST['update_doc']))
		{
			...
			$query="UPDATE his_docs SET doc_fname=?, doc_lname=?,  doc_email=?, doc_dept=?, doc_pwd=?, doc_dpic=? WHERE doc_number = ?";
			$stmt = $mysqli->prepare($query);
			$rc=$stmt->bind_param('ssssss', $doc_fname, $doc_lname, $doc_email, $doc_dept, $doc_pwd, $doc_dpic, $doc_number);
			$stmt->execute();
			/*
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title fs-3 fw-medium mt-2">Update Employee Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group col-md-6">
                                                    ...
                                                    <select id="inputState" required="required" name="doc_dept" class="form-control">
                                                        ...
                                                        <option>Laboratory Control</option>
                                            ...
                                            <button type="submit" name="update_doc" class="ladda-button btn btn-success" data-style="expand-right">Update Details</button>
