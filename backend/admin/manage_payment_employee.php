            ...
            <div class="content-page">
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                    <h4 class="page-title fs-3 fw-medium mt-2">Employee Payment Details</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <table id="demo-foo-filtering" class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>Tk <?php echo $row->pay_emp_salary;?></td>
                                                 
                                                    <td>
                                                        <a href="manage_payment_employee.php?delete_pay_number=<?php echo $row->pay_number;?>" class="badge badge-danger"><i class="fas fa-trash"></i> Delete</a>
                                                        <a href="update_single_employee_payment.php?pay_number=<?php echo $row->pay_number;?>" class="badge badge-success"><i class="fas fa-edit "></i>Update</a>
