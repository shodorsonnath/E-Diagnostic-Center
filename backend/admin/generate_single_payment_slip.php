                ...
                <div class="content-page">
                    <div class="content">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                <div class="col-12">
                                        <h4 class="page-title fs-3 fw-medium mt-2 mb-3">Payment Slip</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                ...
                                <div class="col-12">
                                    <div class="card-box">
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table mt-4 table-centered table-bordered">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">TK <?php echo $taxable_salary;?></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="float-right">
                                                    <p><b>Sub-total:</b> <span class="float-right">TK <?php echo $row->pay_emp_salary;?></span></p>
                                                    <p><b>PAY Tax (16%) :</b> <span class="float-right"> &nbsp;&nbsp;&nbsp; TK <?php echo $taxable_salary;?> </span></p>
                                                    <p><b>Total TK :</b> TK <?php echo $total_salary;?></p>
                                                </div>
