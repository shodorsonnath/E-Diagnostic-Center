                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="page-title-box">
                                        <h4 class="page-title fs-3 fw-medium mt-2">Payment Details</h4>
                                    </div>
                                </div>
                            </div>     
                            <!-- end page title --> 
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-7">
                                                <div class="pl-xl-3 mt-3 mt-xl-0">
                                                    <h2 class="mb-3 font-weight-bold"> <span class="text-secondary">Account Number :</span>   <?php echo $row->acc_number;?></h2>
                                                    <hr>
                                                    <h4> <span class="text-secondary">Employee Name :</span>  <?php echo $row->acc_name;?></h6>
                                                    <hr>
                                                    <h4> <span class="text-secondary">Amount : </span>Tk <?php echo $row->acc_amount;?> </h6>
                                                    <hr>
                                                    <h4 class="align-centre text-secondary">Description:</h6>
