                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="page-title fs-3 fw-medium mt-1">Patient Details</h4>
                            </div>
                        </div>
                    </div>
                    <!-- end page title -->
                                    ...
                                    <table class="table table-bordered toggle-circle mb-0" data-page-size="7">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><a href="view_single_patient.php?pat_id=<?php echo $row->pat_id;?>&&pat_number=<?php echo $row->pat_number;?>"
